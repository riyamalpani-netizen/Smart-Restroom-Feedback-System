...
router.get("/daily", authenticate, authorize("super_admin", "vendor_admin", "facility_manager", "viewer"), getReports);
router.get("/weekly", authenticate, authorize("super_admin", "vendor_admin", "facility_manager", "viewer"), getReports);
router.get("/monthly", authenticate, authorize("super_admin", "vendor_admin", "facility_manager", "viewer"), getReports);

...
const gmailOAuthRoutes = require("./routes/gmailOAuthRoutes");
...
app.use("/api/notifications", notificationChannelRoutes);
app.use("/api/notifications/gmail", gmailOAuthRoutes);
